...
5. 注入 Token、端口、apiKey，加载仓库业务 skills，并禁用所有外部 skills（bundled / 个人 / workspace / 插件），同时写入业务 skills 白名单 `agents.defaults.skills`，运行时新装的 ClawHub / workshop / 插件 skills 也不会被激活
    ...
    "providers": {
      "local": {
        ...
        "models": [
          ...
          {
            "id": "Qwen2.5-Coder-32B-SFT-ALL-V2_QC2",
            "name": "Qwen2.5-Coder-32B-SFT-ALL-V2_QC2",
            "contextWindow": 32768,
            "contextTokens": 24000,
            "maxTokens": 8192
          },
          ...
          {
            "id": "Qwen2.5-Coder-32B-SFT-ALL-V2_QC2-64K",
            "name": "Qwen2.5-Coder-32B-SFT-ALL-V2_QC2-64K",
            "contextWindow": 65536,
            "contextTokens": 65536,
            "maxTokens": 8192
          }
