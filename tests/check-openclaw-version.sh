...
expect_missing "$ROOT/run.bat" 'script\patch-openclaw-runtime.js'
expect_missing "$ROOT/install.bat" 'script\patch-openclaw-runtime.js'
expect_missing "$ROOT/run.sh" 'script/patch-openclaw-runtime.js'
expect_missing "$ROOT/run.sh" '[异常] Control UI 补丁应用失败'
